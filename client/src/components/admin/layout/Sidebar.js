                        ...
                        <ul class="nav flex-column">
                            <NavLink to="/" className="sidebar-link">
                                    ...
                                    <span class="material-symbols-outlined">home</span>
                                        <span id="dash-item" class="ml-2">Dashboard</span>
                                    </a>
                                </li>
                            </NavLink>
                            <NavLink to="/order-details" className="sidebar-link">
                                <li class="nav-item">
                                    <a class="nav-link">
                                    <span class="material-symbols-outlined">list</span>
                                    <span id="dash-item" class="ml-2">Order Details</span>
                                    </a>
                                </li>
                            </NavLink>
                            <NavLink to="/menu-list" className="sidebar-link">
                                <li class="nav-item">
                                    <a class="nav-link">
                                    <span class="material-symbols-outlined">ramen_dining</span>
                                    <span id="dash-item" class="ml-2">Menu List</span>
                                    </a>
                                </li>
                            </NavLink>
                            <NavLink to="/add-menu" className="sidebar-link">
                                <li class="nav-item">
                                    <a class="nav-link">
                                    <span class="material-symbols-outlined">add</span>
                                    <span id="dash-item" class="ml-2">Add Menu</span>
                                    </a>
                                </li>
                            </NavLink>
                            <NavLink to="/logout" className="sidebar-link">
                                <li class="nav-item">
                                    ...
                                    <span id="dash-item" class="ml-2">Logout</span>
                                    </a>
                                </li>
                            </NavLink>
                        </ul>
